<template>
  <div class="order-confirm">
        ...
        <div class="order-box">
          <div class="item-address">
            ...
            <div class="addr-list clearfix" >
              <div class="addr-info" v-bind:class="{'checked': index==indexChecked}" @click="indexChecked=index" v-for="(item,index) in list" :key="index">
    ...
    <modal
      title="添加地址"
      btnType="1"
      v-bind:showModal="showEditModal"
...
export default {
  ...
  methods: {
    ...
    orderSubmit(){
      let item = this.list[this.indexChecked]
      if(!item){
        alert('请选择一个收获地址');
        return;
      }

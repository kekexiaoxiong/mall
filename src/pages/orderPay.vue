      ...
      <div class="container">
        <div class="order-wrap">
          ...
          <div class="item-detail"  v-if="showDetail">
            ...
            <div class="item">
              <div class="detail-title">收货信息：{{addressInfo}}</div>
            ...
            <div class="item">
              ...
              <div class="detail-info">电子发票 个人</div>5
            </div>
          </div>
        </div>
        <div class="item-pay">
  ...
  methods: {
    getOrderDetail() {
      this.axios.get(`/orders/${this.orderNo}`).then(res => {
        ...
        this.addressInfo = `${item.receiverName} ${item.receiverPhone} ${item.receiverProvince} ${item.receiverCity} ${item.receiverDistrict}`;
